      ...
      <section className="flex flex-col items-center justify-center gap-4 py-12 md:py-20">
        <motion.div
          ...
          <motion.div className={subtitle({ class: 'mt-6 mx-auto' })} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.8, delay: 0.3 }}>
            Заполните форму, и наши специалисты свяжутся с вами для организации демонстрации RVS
          </motion.div>
        </motion.div>
              ...
              <motion.div
                ...
                {formData.success ? (
                  <motion.div
                    ...
                    <p>Спасибо за интерес к RVS. Наши специалисты свяжутся с вами в ближайшее время.</p>
                  </motion.div>
                ) : (
                ...
                <div className="bg-primary/5 p-8 rounded-xl mb-6">
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start gap-3">
                      ...
                      <p className="text-default-700">Персональную демонстрацию платформы RVS</p>
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="text-primary mt-1">
                        <svg
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-default-700">info@rvs.com</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="text-primary mt-1">
        ...
        <motion.div
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              {[
                {
                  question: 'Сколько времени занимает внедрение RVS?',
                  answer:
                    'Базовое внедрение RVS занимает от 4 недель. Точные сроки зависят от масштаба организации и требуемой кастомизации. Наши специалисты предоставят детальный план внедрения после анализа ваших потребностей.',
                },
                {
                  question: 'Можно ли интегрировать RVS с нашими существующими системами?',
                  answer:
                    'Да, RVS поддерживает интеграцию с широким спектром корпоративных систем через API, включая системы мониторинга, ERP, CRM, HR-системы, Active Directory и другие. Детали интеграции обсуждаются на этапе планирования внедрения.',
                },
                {
                  question: 'Какие отделы могут использовать RVS?',
                  answer:
                    'RVS — это универсальная ESM-платформа, которую могут использовать все подразделения компании: ИТ, HR, административно-хозяйственный отдел, юридический отдел, бухгалтерия, маркетинг и другие. Каждый отдел может настроить свои процессы и услуги.',
                },
                {
                  question: 'Как происходит обучение сотрудников работе с системой?',
                  answer:
                    'В рамках внедрения мы проводим обучение администраторов и ключевых пользователей системы. Также предоставляем доступ к базе знаний и видеоурокам. Интерфейс RVS интуитивно понятен, что сокращает время на обучение рядовых пользователей.',
                },
              ].map((faq, index) => (
